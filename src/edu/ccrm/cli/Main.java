...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("Welcome to the VIT Bhopal Campus Course & Records Manager!");
        boolean exit = false;
    ...
    private static void printMainMenu() {
        ...
        System.out.println("3. Manage Enrolled Students");
        System.out.println("4. Manage Student Grading");
    ...
    private static void manageStudents() {
        ...
        System.out.println("4. Deactivate a Registration");
